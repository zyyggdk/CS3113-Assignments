//Assignment 6 Yiyang Zeng yz3622
//Sound effect
...
public:
	...
	GLboolean RecSATCollision(Entity* other) {
		...
		if (CheckSATCollision(e1Points, e2Points, penetration)) {
			Mix_PlayChannel(-1, someSound1, 0);
...
void Setup() {
	...
	someSound1 = Mix_LoadWAV("1.wav");
	someSound2 = Mix_LoadWAV("2.wav");
	music = Mix_LoadMUS("Charge.wav");
	Mix_VolumeMusic(30);
